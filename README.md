...
- **מיזוג Manager ו־Staff_Member ל־Worker:**  
...
- **הסרת כפילויות ושמירה על עקרון נורמליזציה:**  
...
- **שדרוג טבלת רשומות רפואיות (`MedicalRecord`):**  
...
- **הפיכת `Appointment` מיישות חלשה לקשר ישיר:**  
...
- **יצירת קשר בין מתנדבים לתוכניות טיפול (`VolunteerInTreatPlan`):**  
...
- **שינוי שמות טבלאות לצורך אחידות ובהירות:**  
...
שינויים אלה נועדו להבטיח מבנה נתונים נוח, קריא ותחזוקתי, תוך שמירה על עקרונות של תכנון בסיסי נתונים תקני ונורמלי (3NF).
