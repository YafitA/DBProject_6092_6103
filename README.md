### **README מותאם לפרויקט שלך – מערכת ניהול מתנדבים בבית חולים**

---

# **Hospital Volunteer Management System**  

**פרויקט מסד נתונים – ניהול מתנדבים בבית חולים / עזר מציון**  
**הוגש על ידי: [שמות המגישות]**  
...
מערכת זו נועדה לנהל את פעילות המתנדבים בבית חולים **שיבא / עזר מציון**, ולספק מענה לארגון ושיבוץ נכון של מתנדבים לפי כישוריהם והתאמה לפרויקטים.  
...
💡 **סיכום**  
כל השלבים בוצעו לפי הדרישות: עיצוב, בניית מסד הנתונים, הכנסת נתונים בשלוש שיטות שונות ושמירה על קשרי ה-FK בצורה נכונה. 🚀
